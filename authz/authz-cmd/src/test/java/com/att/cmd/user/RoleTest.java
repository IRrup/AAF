...
public class RoleTest {
	...
	public static void setUp () throws NoSuchFieldException, SecurityException, Exception, IllegalAccessException {
		...
		when(_role._exec(Mockito.anyInt(), Mockito.anyString(),Mockito.anyString())).thenCallRealMethod();
		...
		when(_role.same(Mockito.any(Retryable.class))).thenReturn(206);
	...
	public void exec_206() {
		try {
			assertEquals(_role._exec(0, "add","del","reset"),500);
		} catch (CadiException e) {
